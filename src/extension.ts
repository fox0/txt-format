...
function processTextPre() {
	console.log('processTextPre');
	// TODO
}

function processTextPost() {
...
export function activate(context: vs.ExtensionContext) {
	...
	function wikify() {
		...
		const pos1: vs.Position = editor.document.positionAt(txt.length);
